...
export class AdminComponent implements OnInit, OnDestroy {
  ...
  async initFaqDefaults(): Promise<void> {
    this.faqItems = [
      { question: 'What areas do you serve?', answer: 'We serve Chicago and Suburbs including La Grange, Villa Park, Brookfield, Westchester, Riverside, Berwyn, Cicero, Lyons, North Riverside, and surrounding communities. Contact us to confirm service availability for your specific location.' },
      { question: 'What are your operating hours?', answer: 'We are available Monday through Friday, 8 AM to 5 PM. Outside of those hours, emergency service is available — see below.' },
      ...
      { question: 'How do I schedule an appointment?', answer: `You can schedule an appointment by calling us at ${BUSINESS.phoneDisplay}, emailing us at ${BUSINESS.email}, or using our online contact form.` },
